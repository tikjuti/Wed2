...
?>
    ...
    <div>
        ...
        <h6>Trạng Thái : <?php if($order_status=="0") echo "<span style='font-weight: bold;;color:#ff0000'>Chưa xử lí</span>"; else if($order_status=="1") echo "<span style='font-weight: bold;;color:#1E90FF'>Đã xử lí</span>"?></h6>
    </div>
</div>
